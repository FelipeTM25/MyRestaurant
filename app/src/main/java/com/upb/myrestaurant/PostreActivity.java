...
public class PostreActivity extends ListActivity {
    ...
    private void setData() {
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.opc_postre1);
        productoActual1.precioProducto = this.getResources().getString(R.string.prec_postre1);
        productoActual1.imagenProducto = R.drawable.tresleches; // Asegúrate de tener la imagen correspondiente
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.opc_postre2);
        productoActual2.precioProducto = this.getResources().getString(R.string.prec_postre2);
        productoActual2.imagenProducto = R.drawable.flancaramelo; // Asegúrate de tener la imagen correspondiente
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.opc_postre3);
        productoActual3.precioProducto = this.getResources().getString(R.string.prec_postre3);
        productoActual3.imagenProducto = R.drawable.helado; // Asegúrate de tener la imagen correspondiente
