...
public class BebidaActivity extends ListActivity {
    ...
    private void setData() {
        ...
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.opc_bebida1);
        productoActual1.precioProducto = this.getResources().getString(R.string.prec_bebida1);
        productoActual1.imagenProducto = R.drawable.jugonaranja; // Asegúrate de tener la imagen correspondiente
        ...
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.opc_bebida2);
        productoActual2.precioProducto = this.getResources().getString(R.string.prec_bebida2);
        productoActual2.imagenProducto = R.drawable.gaseosa; // Asegúrate de tener la imagen correspondiente
        ...
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.opc_bebida3);
        productoActual3.precioProducto = this.getResources().getString(R.string.prec_bebida3);
        productoActual3.imagenProducto = R.drawable.limonada; // Asegúrate de tener la imagen correspondiente
