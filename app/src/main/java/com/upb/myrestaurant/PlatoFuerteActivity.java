...
public class PlatoFuerteActivity extends ListActivity {
    ...
    private void setData() {
        ...
        productoActual1.nombreProducto = this.getResources().getString(R.string.plato_fuerte1);
        productoActual1.ingredientesProducto = this.getResources().getString(R.string.opc_plato_fuerte1);
        productoActual1.precioProducto = this.getResources().getString(R.string.prec_plato_fuerte1);
        productoActual1.imagenProducto = R.drawable.bandeja_paisa; // Asegúrate de tener la imagen correspondiente
        arregloProductos.add(productoActual1);

        // Plato Fuerte 2
        Producto productoActual2 = new Producto();
        productoActual2.nombreProducto = this.getResources().getString(R.string.plato_fuerte2);
        productoActual2.ingredientesProducto = this.getResources().getString(R.string.opc_plato_fuerte2);
        productoActual2.precioProducto = this.getResources().getString(R.string.prec_plato_fuerte2);
        productoActual2.imagenProducto = R.drawable.arrozpollo; // Asegúrate de tener la imagen correspondiente
        arregloProductos.add(productoActual2);

        // Plato Fuerte 3
        Producto productoActual3 = new Producto();
        productoActual3.nombreProducto = this.getResources().getString(R.string.plato_fuerte3);
        productoActual3.ingredientesProducto = this.getResources().getString(R.string.opc_plato_fuerte3);
        productoActual3.precioProducto = this.getResources().getString(R.string.prec_plato_fuerte3);
        productoActual3.imagenProducto = R.drawable.casuelamariscos; // Asegúrate de tener la imagen correspondiente
